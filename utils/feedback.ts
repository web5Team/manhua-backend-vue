...
export class Feedback {
    ...
    // 弹出提示
    alert(msg: string) {
        ElMessageBox.alert(msg, this.t('systemPrompt'))
    }
    // 错误提示
    alertError(msg: string) {
        ElMessageBox.alert(msg, this.t('systemPrompt'), { type: 'error' })
    }
    // 成功提示
    ...
    alertWarning(msg: string) {
        ElMessageBox.alert(msg, this.t('systemPrompt'), { type: 'warning' })
    }
    // 通知提示
    notify(msg: string) {
    ...
    // 确认窗体
    confirm(msg: string) {
        return ElMessageBox.confirm(msg, this.t('Kind tips'), {
