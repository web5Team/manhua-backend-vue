    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table
          ...
          <el-table-column label="角色编号" prop="roleId" width="120" sortable="custom" />
          <el-table-column label="角色名称" prop="roleName" :show-overflow-tooltip="true" width="150" sortable="custom" />
          <el-table-column label="权限字符" prop="roleKey" :show-overflow-tooltip="true" width="150" />
          <el-table-column label="显示顺序" prop="roleSort" width="100" sortable="custom" />
          <el-table-column label="状态" align="center" width="100" sortable="custom">
            <template slot-scope="scope" v-permisaction="['admin:sysrole:edit']">
              <el-switch
