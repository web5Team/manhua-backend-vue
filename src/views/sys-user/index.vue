        ...
        <el-row :gutter="20">
          ...
          <el-col :span="20" :xs="24">
            ...
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5">
                <el-button v-permisaction="['admin:sysuser:add']" type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
                  >新增</el-button
                >
              </el-col>
              <el-col :span="1.5">
            ...
            <el-table
             ...
             >
              ...
              <el-table-column label="编号" width="80" align="center" prop="userId" sortable="custom" />
              <el-table-column label="登录名称" width="100" align="center" prop="username" :show-overflow-tooltip="true" sortable="custom" />
              <el-table-column label="用户昵称" align="center" prop="nickName" :show-overflow-tooltip="true" />
              <el-table-column label="部门" align="center" prop="dept.deptName" :show-overflow-tooltip="true" />
              <el-table-column label="手机号码" align="center" prop="phone" width="120" />
              <el-table-column label="状态" width="80" align="center">
                <template slot-scope="scope" v-permisaction="['admin:sysuser:edit']">
                  <el-switch v-model="scope.row.status" v-permisaction="['admin:sysuser:edit']" active-value="1" inactive-value="2" @change="handleStatusChange(scope.row)" />
                </template>
              </el-table-column>
              <el-table-column label="创建时间" align="center" prop="createdAt" width="165" sortable="custom">
                <template slot-scope="scope">
                  <span>{{ parseTime(scope.row.createdAt) }}</span>
                </template>
              </el-table-column>
              <el-table-column label="修改时间" align="center" prop="updatedAt" width="165" sortable="custom">
                <template slot-scope="scope">
