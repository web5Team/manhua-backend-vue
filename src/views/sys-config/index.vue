    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table
          ...
          <el-table-column label="参数主键" width="100" align="center" prop="id" sortable="custom" />
          <el-table-column label="参数名称" align="center" prop="configName" :show-overflow-tooltip="true" sortable="custom" />
          <el-table-column label="参数键名" align="center" prop="configKey" :show-overflow-tooltip="true" sortable="custom" />
          <el-table-column label="参数键值" align="center" width="500" prop="configValue" />
          <el-table-column label="系统内置" align="center" prop="configType" :formatter="typeFormat" sortable="custom" />
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig } from '@/api/sys-config'
