    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table
          ...
          <el-table-column label="字典编号" width="100" align="center" prop="id" sortable="custom" />
          <el-table-column label="字典名称" align="center" prop="dictName" :show-overflow-tooltip="true" sortable="custom" />
...
<script>
import { listType, getType, delType, addType, updateType } from '@/api/sys-dict-type'
