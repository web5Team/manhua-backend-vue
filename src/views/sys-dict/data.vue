    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table
          ...
          <el-table-column label="字典编码" width="100" align="center" prop="dictCode" sortable="custom" />
          <el-table-column label="字典标签" align="center" prop="dictLabel" sortable="custom" />
          <el-table-column label="字典键值" align="center" prop="dictValue" sortable="custom" />
          <el-table-column label="字典排序" align="center" prop="dictSort" sortable="custom" />
...
<script>
import { listData, getData, delData, addData, updateData, exportData } from '@/api/sys-dict-data'
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const dictIds = (row.dictCode && [row.dictCode]) || this.ids
