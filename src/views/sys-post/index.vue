    ...
    <template #wrapper>
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="70px">
          ...
          <el-form-item label="岗位名称" prop="postName" label-width="70px">
            <el-input
        ...
        <el-table
          ...
          <el-table-column label="岗位编号" width="100" align="center" prop="postId" sortable="custom" />
...
<script>
import { listPost, getPost, delPost, addPost, updatePost } from '@/api/sys-post'
