    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-scrollbar v-else>
          ...
          >
            <el-table-column prop="name" align="center" label="文件名" sortable="custom">
            ...
            <el-table-column prop="updatedAt" align="center" label="修改日期" sortable="custom">
              <template slot-scope="scope">
                <span
                  v-if="!scope.row.open"
                  v-text="parseTime(scope.row.updatedAt)"
                />
              </template>
            </el-table-column>
            <el-table-column prop="type" align="center" label="文件类型" sortable="custom">
              <template slot-scope="scope">
                <div class="type">
            ...
            <el-table-column prop="size" align="center" label="文件大小" sortable="custom">
              <template slot-scope="scope">
  ...
  methods: {
    ...
    getList() {
      ...
      if (pId) {
        ...
        this.queryParams.pageIndex = this.pageNo
        sysfileinfoList(this.queryParams).then(ret => {
          if (ret.code === 200) {
    ...
    handleAction(e) {
      switch (e) {
        ...
        case 2:
          ...
          break
        case 3:
          sysfileinfoDelete({ ids: [this.rightData.currentData.id] }).then(ret => {
            if (ret.code === 200) {
              this.getList()
            }
          })
